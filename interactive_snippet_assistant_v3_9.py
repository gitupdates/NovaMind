#!/usr/bin/env python3
"""Interactive Snippet Assistant v3.9.0

Runs Python snippets in a subprocess with basic resource limits and
provides simple error diagnostics. Version 3.9 adds optional JSON output,
custom interpreter selection, and autopep8 formatting support for greater
flexibility.
"""
...
def main() -> None:
    ...
    parser.add_argument("--format", action="store_true",
                        help="Format code with autopep8 before execution")
    ...
    if args.format:
        if AUTOPEP8_AVAILABLE:
            ...
            print("autopep8 is not installed; skipping formatting")
